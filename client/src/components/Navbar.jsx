            ...
            <div className='flex items-center gap-6 relative'>
                <div className='relative'>
                    ...
                    {showCreditPopup && (
                        ...
                        bg-white shadow-xl border border-gray-200 rounded-xl p-5 z-50'>
                            <p className='text-sm text-gray-600 mb-4'>Need more credits to continue interviews?</p>
                            <button onClick={()=>navigate("/pricing")} className='w-full bg-black text-white py-2 rounded-2xl-lg text-sm'>Buy more credits</button>
                        </div>
                    )}
                </div>
                <div>
                <div className='relative'>
                    ...
                    {showUserPopup && (
                        ...
                        bg-white shadow-xl border border-gray-200 rounded-xl p-4 z-50'>
                            ...
                            <button onClick={handleLogout} className='w-full text-left py-2 text-sm flex items-center gap-2 text-red-500'><HiOutlineLogout size={16}/> Logout</button>
                        </div>
                    )}
                </div>
                </div>
