        ...
        <div className='text-center mb-28'>
          ...
          <div className='flex flex-wrap justify-center gap-4 mt-10'>
            ...
            <Motion.button
              ...
              whileHover={{ opacity: 0.9, scale: 1.03 }}
              whileTap={{ opacity: 1, scale: 0.98 }}
              className='border border-gray-300 px-10 py-3 rounded-full hover:bg-gray-100 transition'>View History</Motion.button>
          </div>
        </div>
            ...
            [
              ...
              `}>
                ...
                <div className='pt-10 text-center'>
                  <div className='text-xs texgre600 font-semibold mb-2 tracking-wider'>{item.step}</div>
                ...
                className='bg-white border border-gray-200 rounded-3xl shadow-sm hover:shadow-xl transition-all'>
                  <div className='flex flex-col md:flex-row items-center gap-8'>
                    ...
                    <div className='w-full md:w-1/2'>
                      <div className='bg-green-50 text-gray-600 w-12 h-12 rounded-xl flex items-center justify-center mb-6'>
                        {item.icon}
                      </div>
